...
if __name__ == "__main__":
    ...
    data["nz_max"] = data[features].apply(lambda x: x[x!=0].max(), axis=1)
    data["nz_min"] = data[features].apply(lambda x: x[x!=0].min(), axis=1)
    data["ez"] = data[features].apply(lambda x: len(x[x==0]), axis=1)
    data["max"] = data[features].apply(lambda x: x.max(), axis=1)
    data["min"] = data[features].apply(lambda x: x.min(), axis=1)
    ...
    test["nz_max"] = test[features].apply(lambda x: x[x!=0].max(), axis=1)
    test["nz_min"] = test[features].apply(lambda x: x[x!=0].min(), axis=1)
    test["ez"] = test[features].apply(lambda x: len(x[x==0]), axis=1)
    test["max"] = test[features].apply(lambda x: x.max(), axis=1)
    test["min"] = test[features].apply(lambda x: x.min(), axis=1)
